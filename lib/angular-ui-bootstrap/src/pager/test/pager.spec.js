describe('pager directive', function() {
  ...
  it('aligns previous & next pages', function() {
  ...
  it('disables the "next" link if current pages is num-pages', function() {
    updateCurrentPage(5);
  ...
  describe('`items-per-pages`', function() {
    beforeEach(function() {
      $rootScope.perpage = 5;
      element = $compile('<ul uib-pager total-items="total" items-per-pages="perpage" ng-model="currentPage"></ul>')($rootScope);
      $rootScope.$digest();
    });
    ...
    it('selects the last pages when it is too big', function() {
  ...
  describe('setting `pagerConfig`', function() {
    ...
    it('should not align previous & next pages link', function() {
