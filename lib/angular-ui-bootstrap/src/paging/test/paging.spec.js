describe('paging factory', function() {
  ...
  describe('init', function() {
    ...
    describe('without itemsPerPage', function() {
      ...
      it('should update the pages when total items changes', function() {
    ...
    describe('with itemsPerPage', function() {
      ...
      it('should update the pages when itemsPerPage changes', function() {
        spyOn(ctrl, 'calculateTotalPages').and.returnValue(5);
        spyOn(ctrl, 'updatePage');
        $rootScope.$digest();
  ...
  describe('render', function() {
    it('should set pages to 1 when invalid', function() {
    ...
    it('should set pages to view value when valid', function() {
  ...
  describe('select pages', function() {
    beforeEach(function() {
    ...
    it('should change the pages', function() {
      $scope.selectPage(12);
    ...
    it('should not change the pages to one out of range', function() {
      $scope.selectPage(-1);
    ...
    describe('on click', function() {
      ...
      it('should not change the pages if disabled and from an event', function() {
  ...
  describe('update pages', function() {
    beforeEach(function() {
    ...
    it('should select the last pages if pages is above total', function() {
      $scope.page = 12;
    ...
    it('should execute render if pages is within range', function() {
      $scope.page = 5;
